<?php
// PEPPOL PINT AE — Self-Billing Invoice template
// InvoiceTypeCode: 389 (Self-billed invoice)
// Party roles: AccountingSupplierParty = actual supplier (SET_BUYER_*)
//              AccountingCustomerParty = buyer who issues SB invoice (SET_SELLER_*)
return <<<XML
...
<Invoice xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2"
    ...
    SET_DUE_DATE
    <cbc:InvoiceTypeCode>SET_INVOICE_TYPE_CODE</cbc:InvoiceTypeCode>
    <cbc:DocumentCurrencyCode>SET_CURRENCY</cbc:DocumentCurrencyCode>

    <!-- In self-billing: AccountingSupplierParty = the actual supplier (receives SB invoice) -->
    ...
    <!-- In self-billing: AccountingCustomerParty = the buyer who issues SB invoice -->
