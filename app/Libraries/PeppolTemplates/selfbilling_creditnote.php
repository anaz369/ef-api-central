<?php
// PEPPOL PINT AE — Self-Billing Credit Note template
// CreditNoteTypeCode: 261 (Self billed credit note)
// Party roles: AccountingSupplierParty = actual supplier (SET_BUYER_*)
//              AccountingCustomerParty = buyer who issues SB credit note (SET_SELLER_*)
return <<<XML
...
<CreditNote xmlns="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2"
    ...
    <!-- In self-billing: AccountingSupplierParty = the actual supplier (receives SB credit note) -->
    ...
    <!-- In self-billing: AccountingCustomerParty = the buyer who issues SB credit note -->
